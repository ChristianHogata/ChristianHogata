...
- **Multi-tenant SaaS platforms** with JWT auth and role-based access
- **Restaurant management systems** (POS, online ordering, kitchen display)
- **Financial modules** (accounts payable, billing, BI dashboards)
- **Driving school platforms** (scheduling, payments, class management)
- **Desktop applications** with Delphi + Electron hybrid approach
